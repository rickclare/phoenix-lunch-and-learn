...
CREATE TABLE IF NOT EXISTS "users" ("id" INTEGER PRIMARY KEY AUTOINCREMENT, "name" TEXT, "inserted_at" TEXT NOT NULL, "updated_at" TEXT NOT NULL, "email" CITEXT NOT NULL COLLATE NOCASE, "hashed_password" TEXT, "confirmed_at" TEXT);
...
INSERT INTO schema_migrations VALUES(20250413160203,'2025-04-13T16:20:36');
INSERT INTO schema_migrations VALUES(20250413160306,'2025-04-13T16:20:36');
