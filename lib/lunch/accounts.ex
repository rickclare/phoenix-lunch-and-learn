defmodule Lunch.Accounts do
  ...
  alias Lunch.Accounts.UserNotifier
  ...
  def change_user(%User{} = user, attrs \\ %{}) do
    User.changeset(user, attrs, allow_unchanged_email: true)
  end
  ...
  See `Lunch.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Lunch.Accounts.User.password_changeset/3` for a list of supported options.
