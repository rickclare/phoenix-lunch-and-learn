defmodule Lunch.AccountsTest do
  ...
  describe "users" do
    ...
    test "create_user/1 with valid data creates a user" do
      ...
      valid_attrs = %{name: "some name", email: email}
    ...
    test "update_user/2 with valid data updates the user" do
      user = user_fixture()
      update_attrs = %{name: "some updated name", email: unique_user_email()}
  ...
  describe "register_user/1" do
    ...
    test "validates email when given" do
      {:error, changeset} = Accounts.register_user(%{name: "John", email: "not valid"})
  ...
  describe "update_user_email/2" do
    setup do
      user = unconfirmed_auth_user_fixture()
      email = unique_user_email()
